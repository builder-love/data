...
from dagster_pipelines.cleaning_assets import distinct_github_project_repos
...
defs = Definitions(
    assets=[crypto_ecosystems_project_toml_files, latest_project_toml_files, github_project_orgs, latest_github_project_orgs, github_project_sub_ecosystems, latest_github_project_sub_ecosystems, github_project_repos, latest_github_project_repos, distinct_github_project_repos],
    resources={
