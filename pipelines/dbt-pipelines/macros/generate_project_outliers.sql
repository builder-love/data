-- macros/generate_project_outliers.sql

{% macro generate_project_outliers(
    project_outliers_model
) %}
...
select 
  ...
  project_rank::BIGINT as current_project_rank,
  prior_4_weeks_project_rank::BIGINT as previous_project_rank,
  absolute_project_rank_change_over_4_weeks,
  rank_of_project_rank_change_over_4_weeks

from {{ source('prod_schema', project_outliers_model) }}
